...
class LoginForm extends Component {
  ...
  handleSubmit(e) {
    ...
    defaultApp.auth().signInWithEmailAndPassword(email, password).catch(function(error) {
      // Handle Errors here.
        ...
        <div className="mdl-card__supporting-text">
          <form id="LoginForm" onSubmit={this.handleSubmit}>
            <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
              <input className="mdl-textfield__input" type="text" id="email_address" name="email_address" />
              <label className="mdl-textfield__label" htmlFor="email_address">Email</label>
            </div>
            <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
